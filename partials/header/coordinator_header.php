                                    ...
                                    <div class="pb-1 mt-1 w-full">
                                        ...
                                        <ul class="flex flex-col gap-3 mt-3 w-full">
                                            ...
                                            <li><a href="/attendance_take.php"
                                                    class="text-sm text-[#747171] w-full flex hover:text-[#37908e] transition-all <?= $tab === "attendance" && $subtab === "take-attendance" ? "border border-gray-300 bg-white rounded-sm p-2 pointer-events-none" : "" ?>">Justificativas de Falta</a>
                                            </li>
                                        </ul>
                                        </p>
                                    </div>
