                                    ...
                                    <div class="pb-1 mt-1 w-full">
                                        ...
                                        <ul class="flex flex-col gap-3 mt-3 w-full">
                                            ...
                                            <li><a href="/materials.php"
                                                    class="text-sm text-[#747171] w-full flex hover:text-[#37908e] transition-all <?= $tab === "class" && $subtab === "academic-structure" ? "border border-gray-300 bg-white rounded-sm p-2 pointer-events-none" : "" ?>">Materiais Didáticos</a></li>
                                        </ul>
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    <div class="pb-1 mt-1 w-full">
                                        ...
                                        <ul class="flex flex-col gap-3 mt-3 w-full">
                                            ...
                                            <li><a href="/attendance_justify_abscense.php"
                                                    class="text-sm text-[#747171] w-full flex hover:text-[#37908e] transition-all <?= $tab === "attendance" && $subtab === "take-attendance" ? "border border-gray-300 bg-white rounded-sm p-2 pointer-events-none" : "" ?>">Justificar Ausência</a>
                                            </li>
                                        </ul>
                                        </p>
                                    </div>
                                    ...
                                    <div class="pb-1 mt-1 w-full">
                                        ...
                                        <ul class="flex flex-col gap-3 mt-3 w-full">
                                            <li><a href="/enrollment_request_enrollment_lock.php"
                                                    class="text-sm text-[#747171] w-full flex hover:text-[#37908e] transition-all <?= $tab === "enrollment" && $subtab === "enroll-student" ? "border border-gray-300 bg-white rounded-sm p-2 pointer-events-none" : "" ?>">Solicitar Trancamento</a></li>
                                        </ul>
                                        </p>
                                    </div>
                                </div>
