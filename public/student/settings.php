...
<div class="flex items-end gap-4 w-full">
  ...
  <div class="flex flex-col w-1/2 text-gray-500">
    <label class="label-text text-gray-500" for="discipline">Matricula</label>
    <input type="text" placeholder="222.222.222.22"
      class="input bg-white text-gray-500 placeholder:text-gray-400 border-gray-300 focus:outline-[#F73C39]" id="name"
      disabled />
    <label class="label-text text-gray-500" for="discipline">Nome</label>
    <input type="text" placeholder="Lucas da Silva"
    ...
    <input type="text" placeholder="lucas.silva@sanquim.com.br"
      class="input bg-white text-gray-500 placeholder:text-gray-400 border-gray-300 focus:outline-[#F73C39]"
      id="name" />
